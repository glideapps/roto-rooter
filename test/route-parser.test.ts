...
import { parseRoutes, getAllRoutePaths, matchRoute, matchDynamicPattern } from "../src/parsers/route-parser.js";
...
describe("route-parser", () => {
  describe("parseRoutes", () => {
    ...
    it("should extract params from route paths", () => {
      const routes = parseRoutes(fixturesDir);
      const employeeDetailRoute = routes.find((r) => r.path === "/employees/:id");
